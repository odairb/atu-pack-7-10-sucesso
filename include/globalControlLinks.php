...
'linkinfo' => array($app_strings['LBL_TRAINING'] => 'javascript:void(window.open(\'https://lidercrm.com/guia_do_usuario.pdf\'))'),
'submenu' => ''
 );
$global_control_links['help'] = array(
'linkinfo' => array($app_strings['LBL_TRAINING2'] => 'javascript:void(window.open(\'https://lidercrm.com/index.php/video-aulas-do-lidercrm/\'))'),
'submenu' => ''
 );
