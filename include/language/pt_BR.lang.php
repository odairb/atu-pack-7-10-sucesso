...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
            ...
            'SugarFeed' => 'Feed do LíderCRM',
            'SugarFavorites' => 'Favoritos do LíderCRM',
    ...
    'moduleListSingular' => array(
            ...
            'Campaigns' => 'Campanha',
            'Documents' => 'Documento',
            'SugarFollowing' => 'LíderCRM Following',
            'Sync' => 'Sincronizar',
            'Users' => 'Usuário',
            'SugarFavorites' => 'Favoritos do LíderCRM',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'in_total_group_stages' => array(
        ...
        'Closed Accepted' => 'Fechada Aceita',
        'Closed Lost' => 'Fechada Perdida',
    ...
    'activity_status_type_dom' => array(''=>'--Nenhum--',
        'active' => 'Ativo',
        'inactive' => 'Inativo',
    ),
    ...
    'dom_email_link_type' => array('sugar' => 'Cliente de e-mail LíderCRM',
...
$app_strings = array(
    ...
    'LBL_ROUTING_ACTIONS_DELETE_BEAN' => 'Excluir Objeto LíderCRM',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_SELECT_TITLE' => 'Selecione destinatários do e-mail',
    ...
    'LBL_EMAIL_ARCHIVE_TO_SUGAR' => 'Importar ao LíderCRM',
    ...
    'LBL_EMAIL_ATTACHMENTS2' => 'Dos Documentos LíderCRM',
    ...
    'LBL_EMAIL_COMPOSE_ERR_NO_RECIPIENTS' => 'Por favor, informe o(s) destinatário(s) deste e-mail.',
    ...
    'LBL_EMAIL_COMPOSE_READ' => 'Ler & Escrever e-mail',
    ...
    'LBL_EMAIL_DISPLAY_MSG' => 'Exibindo e-mail(s) {0} - {1} de {2}',
    ...
    'LBL_EMAIL_EMPTY_MSG' => 'Nenhum e-mail a exibir.',
    'LBL_EMAIL_EMPTY_ADDR_MSG' => 'Nenhum endereço de e-mail a exibir.',
    ...
    'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME' => 'Nomes das Pastas LíderCRM devem ser únicos.',
    'LBL_EMAIL_ERROR_EMPTY' => 'Por favor, informe algum critério de pesquisa.',
    'LBL_EMAIL_ERROR_GENERAL_TITLE' => 'Ocorreu um erro',
    'LBL_EMAIL_ERROR_LIST_NAME' => 'Já existe uma lista de e-mail com este nome',
    ...
    'LBL_EMAIL_IMPORT_EMAIL' => 'Importar ao LíderCRM',
    ...
    'LBL_EMAIL_MENU_HELP_ADD_FOLDER' => 'Criar uma Pasta (remota ou no LíderCRM)',
    'LBL_EMAIL_MENU_HELP_ARCHIVE' => 'Arquivar este(s) e-mail(s) no LíderCRM',
    'LBL_EMAIL_MENU_HELP_COMPOSE_TO_LIST' => 'Escrever e-mail para as listas de e-mails selecionadas',
    'LBL_EMAIL_MENU_HELP_CONTACT_COMPOSE' => 'Escrever e-mail para este contato',
    'LBL_EMAIL_MENU_HELP_CONTACT_REMOVE' => 'Remover um Contato',
    'LBL_EMAIL_MENU_HELP_DELETE' => 'Excluir este(s) e-mail(s)',
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER' => 'Excluir uma Pasta (remota ou no LíderCRM)',
    ...
    'LBL_EMAIL_MENU_HELP_MARK_FLAGGED' => 'Marcar este(s) e-mail(s) sinalizado(s)',
    ...
    'LBL_EMAIL_MENU_HELP_MARK_UNREAD' => 'Marcar estes e-mail(s) como não lidos',
    'LBL_EMAIL_MENU_HELP_REMOVE_LIST' => 'Remover Listas de Emails',
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'Renomeie uma Pasta (remota ou no LíderCRM)',
    'LBL_EMAIL_MENU_HELP_REPLY' => 'Responder a este(s) e-mail(s)',
    'LBL_EMAIL_MENU_HELP_REPLY_ALL' => 'Responder a todos os destinatários para este(s) e-mail(s)',
    ...
    'LBL_EMAIL_SETTINGS_AUTO_IMPORT' => 'Importar e-mail ao visualizar',
    ...
    'LBL_EMAIL_SETTINGS_TAB_POS' => 'Coloque as Guias na Parte Inferior',
    ...
    'LBL_EMAIL_SPACER_LOCAL_FOLDER' => '[ Pastas LíderCRM ]',
    'LBL_EMAIL_SUBJECT' => 'Assunto',
    'LBL_EMAIL_SUCCESS' => 'Sucesso',
    'LBL_EMAIL_SUGAR_FOLDER' => 'Pasta LíderCRM',
    ...
    'ERR_POTENTIAL_SEGFAULT' => 'Foi detectada uma falha em potencial na segmentação do Apache. Por favor, notifique o administrador do sistema para confirmar este problema e solicite a ele/ela que relate a falha ao LíderCRM.',
    ...
    'ERR_NO_DB' => 'Não foi possível conectar ao banco de dados. Por favor, verifique o arquivo de log de erros do LíderCRM para maiores detalhes.',
    'ERR_DB_FAIL' => 'Falha do banco de dados. Por favor, verifique o arquivo de log de erros do LíderCRM para maiores detalhes.',
    ...
    'ERR_DB_VERSION' => 'LíderCRM {0} arquivos só podem ser utilizados com um banco de dados LíderCRM {1} .',
    ...
    'LBL_QUICK_CREATE_TITLE' => 'CRIAR',
    'LBL_BROWSER_TITLE' => 'LíderCRM',
    'LBL_BUGS' => 'Bugs',
    'LBL_BY' => 'por',
    'LBL_CALLS' => 'Ligações',
    'LBL_CALL' => 'Ligação',
    ...
    'LBL_COUNTRY' => 'País:',
    'LBL_CREATE_BUTTON_LABEL' => 'CRIAR RÁPIDO',
    ...
    'LBL_EMAIL_PDF_BUTTON_LABEL' => 'E-mail PDF',
    'LBL_EMAIL_PDF_BUTTON_TITLE' => 'E-mail PDF',
    'LBL_EMAILS' => 'Emails',
    ...
    'LBL_BILLING_STREET' => 'Endereço:',
    'LBL_SHIPPING_STREET' => 'Endereço:',
    ...
    'LBL_QUOTES_SHIP_TO' => 'Entregar Cotações para',
    'LBL_QUOTES' => 'Cotações',
    ...
    'LBL_SUGAR_COPYRIGHT' => '&copy; 2004-2013 SuiteCRM Inc. O Programa é fornecido COMO ESTÁ, sem garantias.  Licenciado sob <a href="LICENSE.txt" target="_blank" class="copyRightLink">AGPLv3</a>.<br />SuiteCRM é uma marca registrada de SuiteCRM, Inc. Todos os outros nomes de empresas e produtos podem ser marcas registradas de suas respectivas empresas, nas quais eles podem estar associados.',
    ...
    'LOGIN_LOGO_ERROR' => 'Por favor, substitua os logotipos do LíderCRM.',
...
Agenda: ",
    ...
    'LBL_TRAINING' => 'Guia do Usuário',
    'LBL_TRAINING2' => 'Vídeo Aulas',
    ...
    'LBL_MAX_DASHLETS_REACHED' => 'Você atingiu o número máximo de Visões do LíderCRM permitidos pelo seu administrador. Por favor, remova uma Visão do LíderCRM para adicionar outra.',
    'LBL_ADDING_DASHLET' => 'Adicionando Visão do LíderCRM ...',
    'LBL_ADDED_DASHLET' => 'Visão do LíderCRM Adicionada',
    'LBL_REMOVE_DASHLET_CONFIRM' => 'Tem certeza que deseja remover esta Visão do LíderCRM?',
    'LBL_REMOVING_DASHLET' => 'Removendo Visão do LíderCRM ...',
    'LBL_REMOVED_DASHLET' => 'Visão do LíderCRM Removida',
    ...
    'LBL_RELOAD_PAGE' => 'Por favor, <a href="javascript: window.location.reload()">recarregue a janela</a> para usar esta Visão do LíderCRM.',
    'LBL_ADD_DASHLETS' => 'Adicionar Visão',
    ...
    'LBL_PORTAL_WELCOME_TITLE' => 'Bem-vindo ao Portal do LíderCRM',
    'LBL_PORTAL_WELCOME_INFO' => 'O Portal do LíderCRM é um framework que fornece uma visão em tempo real de ocorrências, bugs & informativos etc para os clientes.',
    'LBL_LIST' => 'Lista',
...
"5. Clique na opção Importar do menu Ações na aplicação e escolha o arquivo para carregar"
   ',
    ...
    'LBL_EMAIL_PRIM_TITLE' => 'endereço de e-mail principal',
...
$app_strings['LBL_ACCEPT_STATUS'] = 'Aceitar estado';
...
$app_list_strings['moduleList']['AOP_AOP_Case_Events'] = 'Eventos da Ocorrência';
$app_list_strings['moduleList']['AOP_AOP_Case_Updates'] = 'Atualizações da Ocorrência';
...
$app_list_strings['aow_email_type_list']['Record Email'] = 'Registrar e-mail';
...
$app_list_strings['holiday_resource_dom']['Contacts'] = 'Contatos';
...
$app_strings['LBL_QUICK_ACCOUNT'] = 'Nova Conta';
$app_strings['LBL_QUICK_CONTACT'] = 'Novo Contato';
$app_strings['LBL_QUICK_OPPORTUNITY'] = 'Nova Oportunidade';
$app_strings['LBL_QUICK_LEAD'] = 'Novo Cliente Potencial';
$app_strings['LBL_QUICK_DOCUMENT'] = 'Novo Documento';
$app_strings['LBL_QUICK_CALL'] = 'Nova Ligação';
$app_strings['LBL_QUICK_TASK'] = 'Nova Tarefa';
$app_strings['LBL_COLLECTION_TYPE'] = 'Tipo';

$app_strings['LBL_ADD_TAB'] = 'Adicionar Guia';
$app_strings['LBL_EDIT_TAB'] = 'Editar Guias';
$app_strings['LBL_SUITE_DASHBOARD'] = 'Painel do LíderCRM ';
...
$app_strings['LBL_DISCOVER_SUITECRM'] = 'Descubra o LíderCRM';

$app_list_strings['collection_temp_list'] = array('Tasks' => 'Tarefas', 'Meetings' => 'Reuniões', 'Calls' => 'Ligações', 'Notes' => 'Notas', 'Emails' => 'Emails');
