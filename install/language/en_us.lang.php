...
$mod_strings = array(
	...
	'LBL_SYSOPTS_2'                     => 'Que tipo de base de dados será utilizado para a instância LíderCRM que está prestes a instalar?',
	...
	'ERR_ADMIN_USER_NAME_BLANK'         => 'Forneça o nome do usuário para o administrador do LíderCRM. ',
	'ERR_ADMIN_PASS_BLANK'				=> 'Forneça a senha para o usuário administrador do LíderCRM.',

	'ERR_CHECKSYS'                      => 'Foram detectados erros durante a verificação de compatibilidade. Para que a sua instalação LíderCRM funcione corretamente, por favor tome as medidas adequadas para resolver os problemas listados abaixo e pressione o botão para reverificar, ou tente instalar de novo.',
	...
	'ERR_CHECKSYS_CURL'					=> 'Não encontrado: Agendador LíderCRM será executado com funcionalidade limitada.',
	...
	'ERR_CHECKSYS_PHP_INVALID_VER'		=> 'Sua versão de PHP não é suportada pelo LíderCRM. É necessário instalar uma versão que seja compatível com o LíderCRM. Por favor, consulte a Matriz de Compatibilidade nas Notas de Lançamento para obter as Versões de PHP suportadas. Sua versão é ',
	'ERR_CHECKSYS_IIS_INVALID_VER'      => 'A sua versão de IIS não é suportada pelo LíderCRM. É necessário instalar uma versão que seja compatível com a aplicação LíderCRM. Por favor consulte a Matriz de Compatibilidade nas Notas de Lançamento para Versões IIS suportadas. A sua versão é ',
	'ERR_CHECKSYS_FASTCGI'              => 'Detectamos que não está utilizando um mapeamento de handler FastCGI para o PHP. É necessário instalar/configurar uma versão que seja compatível com a aplicação LíderCRM. Por favor consulte a Matriz de Compatibilidade nas Notas de Lançamento para versões suportadas. Consulte &lt;a href=&quot;http://www.iis.net/php/&quot; target=&quot;_blank&quot;&gt;http://www.iis.net/php/&lt;/a&gt; para mais detalhes',
	...
	'LBL_CHECKSYS_XML_NOT_AVAILABLE'        => 'Funções associadas às XML Parser Libraries que são necessárias à aplicação LíderCRM não foram encontradas. Talvez seja necessário descomentar a extensão no arquivo php.ini ou recompilar com arquivo binário correto, dependendo da sua versão de PHP. Por favor consulte o Manual do PHP para mais informações sobre como ativar o Suporte da Base de Dados.',
	'ERR_CHECKSYS_MBSTRING'             => 'Funções associadas com a extensão Multibyte Strings PHP (mbstring) que são necessárias à aplicação LíderCRM não foram encontradas. &lt;br/&gt;&lt;br/&gt;Geralmente, o módulo mbstring não está ativado por defeito no PHP e deve ser ativado com --enable-mbstring quando o binário PHP é construído. Por favor consulte o Manual do PHP para mais informações sobre como ativar o suporte mbstring.',
	...
	'ERR_CHECKSYS_ZLIB'					=> 'Não Encontrado: o LíderCRM colhe enormes benefícios no seu desempenho com a compressão zlib.',
	'ERR_CHECKSYS_ZIP'					=> 'Suporte ZIP não encontrado: LíderCRM precisa de suporte ZIP para processar arquivo comprimidos.',
	'ERR_CHECKSYS_PCRE'					=> 'Biblioteca PCRE não encontrada: LíderCRM precisa de biblioteca PCRE para processar estilo Perl de correspondência de padrão de expressão regular.',
	'ERR_CHECKSYS_PCRE_VER'				=> 'Versão da biblioteca PCRE: LíderCRM precisa de biblioteca PCRE 7.0 ou superior para processar estilo Perl de correspondência de padrão de expressão regular.',
	...
	'ERR_DB_MYSQL_VERSION'				=> 'Sua versão MySQL não é suportada pelo LíderCRM. Você deve instalar uma versão compatível. Por favor consulte as versões compatíveis nas informações para checar qual versão de MySQL é suportada.',
	...
	'ERR_DB_PASSWORD'					=> 'As senhas fornecidas para o administrador da base de dados do LíderCRM não coincidem. Por favor reinsira as mesmas senhas nos campos respectivos.',
	...
	'ERR_DB_USER_EXISTS'				=> 'O nome do usuário da base de dados LíderCRM já existe -- não é possível criar outro com o mesmo nome. Por favor insira um novo nome do usuário.',
	'ERR_DB_USER'						=> 'Insira um nome do usuário para o administrador da base de dados do LíderCRM.',
	'ERR_DBCONF_VALIDATION'				=> 'Por favor corrija os seguintes erros antes de prosseguir:',
	'ERR_DBCONF_PASSWORD_MISMATCH'      => 'As senhas fornecidas para o usuário da base de dados do LíderCRM não coincidem. Por favor reinsira as mesmas senhas nos campos respectivos.',
	...
	'ERR_PASSWORD_MISMATCH'				=> 'As senhas fornecidas para o administrador do LíderCRM não coincidem. Por favor reinsira as mesmas senhas nos campos respectivos.',
	...
	'ERR_PERFORM_NO_TCPIP'				=> '<b>Não detectamos uma conexão de internet.</b> Quando você estiver conectado, por favor visite <a href="http://www.suitecrm.com/">http://www.suitecrm.com/</a> para se registrar no LíderCRM. Ao nos dizer um pouco mais sobre como sua empresa planeja utilizar o LíderCRM, nós garantimos que sempre entregamos o aplicativo certo para as necessidades de seu negócio.',
	...
	'ERR_URL_BLANK'						=> 'Forneça o URL base para a instância LíderCRM.',
	'ERR_UW_NO_UPDATE_RECORD'			=> 'Não foi possível localizar o registro de instalação de',
	'ERROR_FLAVOR_INCOMPATIBLE'			=> 'O arquivo carregado não é compatível com esta versão do LíderCRM: ',
	...
	'ERROR_VERSION_INCOMPATIBLE'		=> 'O arquivo carregado não é compatível com esta versão do LíderCRM:',

	'LBL_BACK'							=> 'Voltar',
	'LBL_CANCEL'                        => 'Cancelar',
	'LBL_ACCEPT'                        => 'Eu Aceito',
	'LBL_CHECKSYS_1'					=> 'Para que a sua instalação LíderCRM funcione corretamente, por favor assegure-se que todos os itens de verificação do sistema abaixo listados estão a verde. Se algum deles estiver a vermelho, por favor tome as medidas necessárias para o corrigir.<BR><BR> Para mais ajuda sobre estas verificações de sistema, por favor visite a <a href="http://www.suitecrm.com" target="_blank">LíderCRM Wiki</a>.',
	...
	'LBL_CHECKSYS_CONFIG'				=> 'arquivo de Configuração LíderCRM (config.php) Editável',
	'LBL_CHECKSYS_CONFIG_OVERRIDE'		=> 'Arquivo de configuração gravável LíderCRM (config_override.php)',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Atenção: Todos os dados do LíderCRM serão apagados<br>se esta caixa estiver verificada.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Remover e Recriar as tabelas LíderCRM Existentes?',
	'LBL_DBCONF_DB_DROP'                => 'Remover Tabelas',
	'LBL_DBCONF_DB_NAME'				=> 'Nome da Base de Dados',
	'LBL_DBCONF_DB_PASSWORD'			=> 'senha do usuário da Base de Dados LíderCRM',
	'LBL_DBCONF_DB_PASSWORD2'			=> 'Reinserir senha do usuário da Base de Dados LíderCRM',
	'LBL_DBCONF_DB_USER'				=> 'Usuário do banco de dados LíderCRM',
	'LBL_DBCONF_SUGAR_DB_USER'          => 'Usuário do banco de dados LíderCRM',
	...
	'LBL_DBCONFIG_MSG3'                 => 'Nome da base de dados que irá conter os dados para a instância LíderCRM que está prestes a instalar:',
	'LBL_DBCONFIG_MSG3_LABEL' => 'Nome da Base de Dados',
	'LBL_DBCONFIG_B_MSG1'               => 'O nome do usuário e senha de um administrador da base de dados que possa criar usuários e tabelas de base de dados e que possa editar a base de dados é necessário para configurar a base de dados do LíderCRM.',
	'LBL_DBCONFIG_B_MSG1_LABEL' => '',
	'LBL_DBCONFIG_SECURITY'             => 'Por razões de segurança, pode especificar um usuário exclusivo da base de dados para se conectar à base de dados do LíderCRM. Este usuário deve ser capaz de editar, Atualizar e recuperar dados na base de dados do LíderCRM que será criada para essa instância. Este usuário pode ser o administrador da base de dados acima especificado, ou você pode fornecer informação nova ou existente do usuário da base de dados.',
	...
	'LBL_DISABLED_HELP_1'				=> 'Para ajuda na instalação, por favor visite o LíderCRM',
	'LBL_DISABLED_HELP_LNK'             => 'http://suitecrm.com/forum/',
	'LBL_DISABLED_HELP_2'				=> 'fóruns de suporte',
	'LBL_DISABLED_TITLE_2'				=> 'Instalação LíderCRM foi Desativada',
	'LBL_DISABLED_TITLE'				=> 'Instalação LíderCRM Desativada',
	...
	'LBL_LANG_1'						=> 'Para utilizar um idioma no LíderCRM diferente do idioma padrão (US-English), pode carregar e instalar o pacote de idioma neste momento. Será também possível carregar e instalar pacotes de idiomas dentro da aplicação LíderCRM. Se quiser ignorar este passo, clique em Próximo.',
	...
	'LBL_LAUNCHING_SILENT_INSTALL'     => 'Instalando o LíderCRM agora. Isto poderá demorar alguns minutos.',
	...
	'LBL_LICENSE_TITLE_2'				=> 'Licença LíderCRM',
	...
	'LBL_LOCALE_DESC'					=> 'As definições locais especificadas serão refletidas globalmente dentro da instância LíderCRM.',
	...
	'LBL_PERFORM_CONFIG_PHP'			=> 'A criar arquivo de configuração do LíderCRM',
	...
	'LBL_PERFORM_CREATE_DEFAULT'		=> 'criar dados padrão do LíderCRM',
	'LBL_PERFORM_CREATE_LOCALHOST'		=> 'criar o nome do usuário e senha da Base de Dados para o servidor local...',
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'criar tabelas de relacionamento do LíderCRM',
	...
	'LBL_PERFORM_OUTRO_1'				=> 'A configuração do LíderCRM',
	...
	'LBL_PERFORM_TABLES'				=> 'Criando tabelas de aplicação, tabelas de auditoria e metadata de relacionamento LíderCRM',
	'LBL_PERFORM_TITLE'					=> 'Executar Configuração',
	'LBL_PRINT'							=> 'Imprimir',
	'LBL_REG_CONF_1'					=> 'Por favor preencha o formulário abaixo para receber anúncios de produtos, novidades de formação, ofertas especiais e convites para eventos especiais da LíderCRM. Nós não vendemos, alugamos, partilhamos ou distribuímos as informações aqui recolhidas a terceiros.',
	...
	'LBL_REG_CONF_3'					=> 'Obrigado por se registar. Clique no botão Concluir para acessar ao LíderCRM. É necessário fazer o login pela primeira vez utilizando o nome "admin" e a senha que inseriu no passo 2.',
	...
	'LBL_SITECFG_ADMIN_Name'            => 'Nome do Administrador da Aplicação LíderCRM',
	'LBL_SITECFG_ADMIN_PASS_2'			=> 'Reinserir senha do Administrador do LíderCRM',
	'LBL_SITECFG_ADMIN_PASS_WARN'		=> 'Atenção: Isto irá substituir a senha do administrador de qualquer instalação anterior.',
	'LBL_SITECFG_ADMIN_PASS'			=> 'senha do Administrador do LíderCRM',
	'LBL_SITECFG_APP_ID'				=> 'ID da Aplicação',
	'LBL_SITECFG_CUSTOM_ID_DIRECTIONS'	=> 'Se Selecionado, deve fornecer um ID de aplicação para substituir o ID auto-gerado. O ID garante que as sessões de uma instância LíderCRM não são utilizados por outras instâncias. Se tem um cluster de instalações LíderCRM, todas elas devem partilhar o mesmo ID de aplicação.',
	'LBL_SITECFG_CUSTOM_ID'				=> 'Forneça o Seu Próprio ID de Aplicação',
	'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS'	=> 'Se Selecionado, deve especificar uma Diretório log para substituir o Diretório padrão do log LíderCRM. Independentemente do local do arquivo, o seu acesso por web browser será restrito através de um redireccionamento .htaccess.',
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Utilizar uma Diretório Log Personalizada',
	'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS'	=> 'Se Selecionado, deve fornecer uma pasta segura para armazenar informação de sessão do LíderCRM. Isto pode ser feito para evitar a vulnerabilidade dos dados da sessão LíderCRM em servidores partilhados.',
	'LBL_SITECFG_CUSTOM_SESSION'		=> 'Utilizar uma Diretório de Sessão Personalizada para o LíderCRM',
	...
	'LBL_SITECFG_SUGAR_UPDATES'			=> 'Configuração de Atualizações LíderCRM',
	'LBL_SITECFG_TITLE'					=> 'Configuração do Site',
	'LBL_SITECFG_TITLE2'                => 'Identificar a Sua Instância LíderCRM',
	'LBL_SITECFG_SECURITY_TITLE'        => 'Segurança do site',
	'LBL_SITECFG_URL'					=> 'URL da Instância LíderCRM',
	'LBL_SITECFG_USE_DEFAULTS'			=> 'Utilizar Padrões?',
	'LBL_SITECFG_ANONSTATS'             => 'Enviar Estatísticas de Utilização Anonimas?',
	'LBL_SITECFG_ANONSTATS_DIRECTIONS'  => 'Se Selecionado, o LíderCRM enviará estatísticas <b>anonimas</b> sobre a sua instalação para a LíderCRM Inc. cada vez que o seu sistema procurar por novas versões. Esta informação irá ajudar-nos a entender melhor como a aplicação é utilizada e guia de melhorias ao produto.',
	'LBL_SITECFG_URL_MSG'               => 'Insira o URL que será usado para acessar à instância LíderCRM após a instalação. O URL também será utilizado como base para os URLs nas páginas da aplicação LíderCRM. O URL deve incluir o servidor web ou o nome da máquina ou o endereço IP.',
	'LBL_SITECFG_SYS_NAME_MSG'          => 'Insira um nome para o seu sistema. Este nome será exibido na barra do título do browser quando os usuários visitarem a aplicação LíderCRM.',
	'LBL_SITECFG_PASSWORD_MSG'          => 'Após a instalação, necessitará de utilizar o administrador LíderCRM (nome do usuário = admin) para acessar à instância LíderCRM. Insira uma senha para este usuário administrador. Esta senha pode ser alterada após o login inicial.',
	...
	'LBL_STEP'							=> 'Passo',
	'LBL_TITLE_WELCOME'					=> 'Bem-vindo ao LíderCRM ',
	'LBL_WELCOME_1'						=> 'Este instalador cria as tabelas da base de dados do LíderCRM e define as variáveis de configuração que necessita para iniciar. O processo completo deve levar cerca de dez minutos.',
	'LBL_WELCOME_2'						=> 'Para documentação de instalação, por favor visite o <a href="http://www.suitecrm.com/" target="_blank">LíderCRM</a>. <BR><BR> Ajuda também pode ser encontrada na Comunidade LíderCRM em <a href="https://suitecrm.com/forum/" target="_blank">Fóruns LíderCRM</a>.',
...
Consulte a matriz de compatibilidade nas notas de lançamento para identificar componentes do sistema compatíveis com a versão do LíderCRM que está a instalar.<br>',
	'REQUIRED_SYS_CHK' => 'Verificação Inicial do Sistema',
	'REQUIRED_SYS_CHK_MSG' =>
		'Quando iniciar o processo de instalação, será executada uma verificação do sistema no servidor web no qual os arquivos do LíderCRM estão localizados a fim de certificar-se de que o sistema está configurado corretamente e tem todos os componentes necessários para concluir com êxito a instalação. <br><br>
...
<li>Os seguintes arquivos de LíderCRM devem ser graváveis: 
<ul>
<li><b>/custom</li> 
<li>/cache</li> 
<li>/módulos</li> 
...
Depois de fazer as alterações necessárias, você pode submeter a verificação do sistema novamente para continuar a instalação. <br>',
	...
	'REQUIRED_INSTALLTYPE_MSG' =>
		'Após a execução da verificação do sistema,pode escolher entre a instalação Típica ou Personalizada.<br><br> Para ambas as instalações <b>Típica</b> e <b>Personalizada</b>, necessitará de saber o seguinte:<br> <ul> <li> <b>Tipo de base de dados</b> que irá alojar os dados do LíderCRM <ul><li>Tipos de base de dados compatíveis: MySQL, MS SQL Server, Oracle.<br><br></li></ul></li> <li> <b>Nome do servidor web</b> ou máquina na qual se encontra a base de dados <ul><li>Pode ser <i>servidor</i> se a base de dados está no seu computador local ou está no mesmo servidor web ou máquina que os seus arquivos LíderCRM.<br><br></li></ul></li> <li><b>Nome da base de dados</b>onde pretende alojar os dados do LíderCRM</li> <ul> <li> Talvez já tenha uma base de dados existente que pretenda usar. Se fornecer o nome de uma base de dados existente, as tabelas na base de dados serão descartadas durante a instalação quando o esquema para a base de dados do LíderCRM for definido.</li> <li> Se ainda não tiver uma base de dados, o nome que fornecer será usado para a nova base de dados que é criada para a instância durante a instalação.<br><br></li> </ul><li><b>Nome do usuário e senha do administrador da base de dados</b> <ul><li>O administrador da base de dados deverá ser capaz de criar tabelas e usuários e editar a base de dados.</li><li>Talvez seja necessário entrar em contacto com o administrador da base de dados se esta não estiver localizada no seu computador local e/ou se você não for o administrador da base de dados.<br><br></ul></li></li><li> <b>Nome e senha do usuário da base de dados LíderCRM</b> </li> <ul> <li> O usuário pode ser o administrador da base de dados, ou pode fornecer o nome de outro usuário da base de dados. </li> <li> Se pretender criar um novo usuário da base de dados para este fim, será capaz de fornecer um novo nome do usuário e senha durante o processo de instalação, e o usuário será criado durante a instalação. </li> </ul></ul><p> Para a configuração <b>Personalizada</b>, também precisa de saber o seguinte: <br> <ul> <li> <b>URL que será utilizado para acessar à instância LíderCRM</b> depois de instalado. Esse URL deve incluir o servidor web ou o nome da máquina ou o endereço IP.<br><br></li> <li> [Opcional] <b> Path para a Diretório de sessão</b> se deseja usar uma Diretório de sessão personalizada para informação LíderCRM de modo a prevenir a vulnerabilidade dos dados de sessão em servidores partilhados.<br><br></li> <li> [Opcional] <b>Path para uma Diretório log personalizada</b> se pretende substituir a Diretório log padrão do LíderCRM.<br><br></li> <li> [Opcional] <b>ID da Aplicação</b> se pretende substituir o ID auto-gerado que garante que a sessões de uma instância LíderCRM não são usadas por outras instâncias.<br><br></li> <li><b>Definição de Caracteres</b> mais utilizados na sua zona.<br><br></li></ul> Para informações mais detalhadas, por favor consulte o Manual de Instalação.',
	...
	'LBL_WELCOME_TITLE_WELCOME'			=> 'Bem-vindo ao LíderCRM ',
	'LBL_WELCOME_TITLE'					=> 'Assistente de Configuração do LíderCRM',
	...
	'LBL_OOTB_SUGARFEEDS'   => 'Limpar Tabelas de Feed do LíderCRM',
	...
	'LBL_REQUIRED_SYSTEM_NAME'=>'Forneça um Nome do Sistema para a instância LíderCRM.',
...
Faça seu login em: $config_site_url
...
$contact_user_link_guid',
	...
	'LBL_WIZARD_SMTP_DESC' => 'Forneça dados da sua conta de e-mail e Senha para o servidor de e-mail de saída padrão. Os Usuários vão receber e-mails do LíderCRM vindos desta conta de e-mail.',
	...
	'LBL_WIZARD_SYSTEM_DESC' => 'Insira o nome de sua organização e logo para a marca do seu LíderCRM.',
	...
	'CURRENT_LOGO_HELP'=>'Este logotipo é exibido no canto superior esquerdo da aplicação LíderCRM.',
	...
	'LBL_WIZARD_LOCALE_DESC' => 'Especifique o fuso horário e a forma como deseja que datas, moedas e nomes apareçam no LíderCRM. Estas serão as definições padrão. Cada Usuário poderá definir suas próprias preferências.',
