...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_ENABLE_MAILMERGE' => 'Ativar a junção de e-mail?',
	...
	'LBL_MAILMERGE_DESC' => 'Esse sinalizador deve ser marcado somente se você tiver o Plugin LíderCRM para Microsoft&reg; Word&reg;.',
	...
	'LBL_PORTAL_ON_DESC' => 'Permite aos usuários gerenciar informações do usuário portal nos registros dos contatos. Usuários do portal podem acessar Ocorrências, Bugs, artigos da Base de Conhecimento e outros dados através da aplicação do Portal do LíderCRM.',
	...
	'LBL_SKYPEOUT_ON_DESC' => 'Ativar o SkypeOut&reg;.. Os números de telefone devem ser formatados corretamente para utilizar este recurso. Formato: "+" "Código Pais" "Telefone", por exemplo +1 (555) 555-1234.',
    ...
    'LBL_DISALBE_CONVERT_LEAD' => 'Desativar a$#39;ção de conversão de Clientes Potenciais para Clientes Potenciais Convertidos',
    'LBL_DISALBE_CONVERT_LEAD_DESC' => 'Se um Cliente Potencial já foi convertido, habilitar esta opção irá remover a ação de conversão de Clientes Potenciais',
    ...
    'CURRENT_LOGO_HELP'=>'Este logotipo é exibido no canto esquerdo do rodapé do aplicativo LíderCRM.',
    ...
    'QUOTES_CURRENT_LOGO'=>'Logotipo das Cotações',
    ...
    'MAX_DASHLETS' => 'Número máximo de Visões do LíderCRM na página inicial',
    ...
    'LBL_LDAP_ADMIN_USER_DESC'=>'Usado para procurar um usuário LíderCRM. [Talvez precise ser totalmente qualificado]. Será vinculado anonimamente se não fornecida.',
    ...
    'LBL_LDAP_BIND_ATTRIBUTE_DESC'=>'Exemplos para ligação de usuários LDAP:[<b>AD</b>:&nbsp;userPrincipalName] [<b>openLDAP</b>:&nbsp;userPrincipalName] [<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;uid] ',
	...
	'SHOW_DOWNLOADS_TAB_HELP' =>'Quando selecionada, a guia de Download aparecerá nas Configurações do Usuário e disponibilizará aos usuários o acesso aos plug-ins do LíderCRM plug-ins e outros arquivos disponíveis.',
	...
	'LBL_LOGGER_LOG_LEVEL'=>'Nível do Log',
        'LBL_LEAD_CONV_OPTION' => 'Opções Conversão de Clientes Potenciais',
        'LEAD_CONV_OPT_HELP' => "Copy - Cria e relaciona cópias de todas as atividades dos Clientes Potenciais para novos registros que são selecionados pelo usuário durante a conversão. Cópias são criadas para cada um dos registros selecionados.<br /><br />Move - Move todas as atividades dos Clientes Potenciais de um novo registro que é selecionado pelo usuário durante a conversão.<br /><br />Não fazer nada - Não faz nada com as atividades dos Clientes Potenciais durante a conversão. As atividades continuam relacionados apenas ao Cliente Potencial .",
    ...
    'PDF_SMALL_HEADER_LOGO_INFO' => 'Esta imagem aparece no cabeçalho padrão dos Documentos PDF de Relatórios. <br>Esta imagem também aparece no canto superior esquerdo do aplicativo LíderCRM.',
...
<br><br>
Para adicionar uma fonte PDF ao LíderCRM, é necessário seguir os passos 1 e 2 na seção "DOCS" da documentação Fontes TCPDF disponível no <a href="http://www.tcpdf.org" target="_blank">Site TCPDF</a>.
...
BSOFR',
    ...
    'LBL_STATUS_FONT_SUCCESS' => 'SUCESSO: A fonte foi adicionada ao LíderCRM.',
...
// Wizard
    ...
    'LBL_WIZARD_WELCOME' => 'Clique em <b>Próximo</b> para inserir sua marca, dados de localização e configurar o LíderCRM agora. Se você deseja configurar o LíderCRM mais tarde, clique em <b>Ignorar</b>.',
    ...
    'LBL_WIZARD_FINISH_TITLE' => 'Você está pronto para usar o LíderCRM!',
    ...
    'LBL_WIZARD_SYSTEM_DESC' => 'Insira o nome e o logotipo de sua empresa para inserir sua marca no LíderCRM.',
    'LBL_WIZARD_LOCALE_DESC' => 'Especifique como você gostaria que os dados sejam exibidos no LíderCRM, baseados em sua localização geográfica. As configurações que você fornecer aqui serão as configurações padrões. Os usuários poderão definir suas próprias preferências.',
    'LBL_WIZARD_SMTP_DESC' => 'Forneça a conta de email que será usada para enviar emails, tais como: notificações de atribuição e novas senhas de usuário. Os usuários receberão emails do LíderCRM, como se os emails fossem enviados da conta de email informada.',
