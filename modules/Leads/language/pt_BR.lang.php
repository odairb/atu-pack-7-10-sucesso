...
$mod_strings = array(
    ...
    //END DON'T CONVERT
    'ERR_DELETE_RECORD' => 'Um número de registro deve ser informado para excluir o Cliente Potencial.',
    ...
    'LBL_BUSINESSCARD' => 'Converter em Cliente Potencial',
    'LBL_CITY' => 'Cidade',
    ...
    'LBL_CONVERTLEAD_TITLE' => 'Converter Contato',
    'LBL_CONVERTLEAD' => 'Converter Cliente Potencial',
    'LBL_CONVERTLEAD_WARNING' => 'Atenção: O estado do Cliente Potencial que você está prestes a converter é "Convertido". Registros de contato ou conta podem já ter sido criados a partir do potencial. Se deseja continuar com a conversão do potencial, clique em Gravar. Para voltar ao potencial sem converter, clique em Cancelar.',
    ...
    'LBL_IMPORT_VCARD' => 'Importar de vCard',
    'LBL_VCARD' => 'vCard',
    'LBL_IMPORT_VCARDTEXT' => 'Criar novo Cliente Potencial automaticamente importando um vCard do seu sistema de arquivos.',
    'LBL_INVALID_EMAIL' => 'E-mail Inválido',
    'LBL_INVITEE' => 'Relatórios',
    'LBL_LAST_NAME' => 'Último Nome',
    'LBL_LEAD_SOURCE_DESCRIPTION' => 'Descrição da Fonte do Cliente Potencial',
    'LBL_LEAD_SOURCE' => 'Fonte do Cliente Potencial',
    ...
    'LBL_LIST_LEAD_SOURCE_DESCRIPTION' => 'Descrição da Fonte do Cliente Potencial',
    ...
    'LBL_MODULE_TITLE' => 'Clientes Potenciais: Tela Principal',
    'LBL_NAME' => 'Nome',
    ...
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Selecionar os Clientes Potenciais Marcados',
    'LBL_STATE' => 'Estado',
    ...
    'NTC_REMOVE_CONFIRMATION' => 'Tem a certeza que pretende remover este Cliente Potencial desta ocorrência?',
...
//Convert lead tooltips
    ...
    'LBL_COPY_TIP' => 'Quando selecionado, campos do cliente potencial serão copiados para campos com o mesmo nome nos registros a criar.',
    ...
    'LBL_ACTIVITIES_MOVE_HELP' => "Selecionar o registro para o qual mover as atividades do Cliente Potencial. Tarefas, ligações, reuniões, anotações  e e-mails serão movidos para o registro selecionado (s).",
    'LBL_ACTIVITIES_COPY_HELP' => "Selecionar o registro (s) para o qual criar cópias das atividades do Cliente Potencial. Tarefas novas, ligações, reuniões e anotações será criado para cada um dos registro selecionado (s). E-mails serão relacionadas com o registro selecionado (s).",
    //For export labels
