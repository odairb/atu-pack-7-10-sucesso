...
$mod_strings = array (
	'ERR_DELETE_RECORD' => 'Para excluir a reunião, um número de registo deve ser informado.',
  ...
  //For export labels
    ...
    'LBL_SYNCED_RECURRING_MSG' => 'Esta reunião foi originada em outro sistema e sincronizada com o LíderCRM. Para fazer alterações, vá para ao registro original da reunião no outro sistema. As alterações feitas no outro sistema podem ser sincronizadas com esse registro.',
