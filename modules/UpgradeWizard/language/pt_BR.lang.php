 ...
 * CRM is an extension to SugarCRM Community Edition developed by Salesagility Ltd.
...
$mod_strings = array(
	...
	'ERR_UW_FLAVOR'								=> 'Versão da Atualização do LíderCRM: ',
	'ERR_UW_LOG_FILE_UNWRITABLE'				=> './upgradeWizard.log não pôde ser criado/gravado.  Por favor, corrija as permissões no diretório do LíderCRM.',
	...
	'ERR_UW_MYSQL_VERSION'						=> 'LíderCRM requer MySQL versão 4.1.2 ou mais recente.  Encontrada: ',
	'ERR_UW_OCI8_VERSION'				        => 'Sua versão do Oracle não é suportada pelo LíderCRM. Você precisa instalar uma versão compatível. Favor consultar as opções compatíveis nos releases.',
	...
	'ERR_UW_VERSION'							=> 'LíderCRM - Versão do Sistema: ',
	'ERR_UW_PHP_VERSION'							=> 'Versão do PHP: ',
	'ERR_UW_SUITECRM_VERSION'							=> 'LíderCRM - Versão do Sistema: ',
	...
	'LBL_UW_COMMIT_ADD_TASK_OVERVIEW'			=> 'Por favor utilize o seu método preferido de diff para juntar os arquivos. Até então a sua instalação do LíderCRM estará incompleta.',
	'LBL_UW_COMPLETE'							=> 'Completo',
	'LBL_UW_CONTINUE_CONFIRMATION'              => 'Esta nova versão do LíderCRM contém um novo acordo de licença. Pretende continuar?',
	...
	'LBL_UW_FILE_NEEDS_DIFF'					=> 'O arquivo requer Diff manual',
	...
	'LBL_UW_START_DESC'							=> 'Bem-vindo ao Assistente de atualização LíderCRM. Este ambiente é projetado para ajudar os administradores quando forem fazer a atualização do LíderCRM. Por favor siga as instruções dadas cuidadosamente.',
	'LBL_UW_START_DESC2'						=> 'Recomendamos que realize a atualização num servidor clone antes de realizar no servidor de produção. Por favor faça o backup da sua base de dados e arquivos do sistema (todos os arquivos na sua pasta LíderCRM) antes de realizar a operação - prevenir sempre é melhor do que remediar.',
	...
	'LBL_UW_SYSTEM_CHECK_CHECKING'				=> 'Verificando, por favor espere. Isto pode levar mais do que 30 segundos.',
    ...
    'LBL_UW_DORP_THE_OLD_SCHMEA' 				=> 'Pretende que o LíderCRM remova o obsoleto 451 Schema?',
	...
	'ERR_CHECKSYS_PHP_INVALID_VER'      => 'A sua versão de PHP não é suportada pelo LíderCRM. Necessita de instalar uma versão que seja compatível com a aplicação LíderCRM. Por favor consulte a Matriz de Compatibilidade nas Notas de Lançamento para Versões de PHP suportadas. A sua versão é',
	...
	'LBL_HOME_PAGE_4_NAME' => 'Definições do Rastreador',
    ...
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'O arquivo carregado não é compatível com esta versão do LíderCRM:',
    'ERROR_FLAVOR_INCOMPATIBLE'  => 'O arquivo carregado não é compatível com esta versão (Community Edition, Professional ou Enterprise) do LíderCRM:',
