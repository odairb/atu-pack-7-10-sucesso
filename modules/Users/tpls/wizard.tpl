            ...
            <td>
                <div class="edit view">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="left" scope="row" colspan="4"><p>{$MOD.LBL_WIZARD_PERSONALINFO_DESC}</p></td>
                        </tr>
                        <tr>
            ...
            <td>
                <div class="edit view">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="left" scope="row" colspan="4"><p>{$MOD.LBL_WIZARD_LOCALE_DESC}</p></td>
                        </tr>
                        <tr>
                ...
                <td>
                    <div class="edit view">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="left" scope="row" colspan="4"><p>{$MOD.LBL_WIZARD_SMTP_DESC}</p></td>
                            </tr>
                            <tr>
